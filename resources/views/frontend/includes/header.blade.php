                ...
                <div class="navbar-collapse-header">
                    <div class="row">
                        <div class="col-6 collapse-brand">
                            <a href="/">
                                <img src="{{asset('img/logogalipat.png')}}" height="35" alt="Logo Impact">
                            </a>
                        </div>
                            ...
                            <div class="col-auto px-0" data-dropdown-content>
                                <div class="list-group list-group-flush">
                                    ...
                                    <a href="{{ route('register') }}"
                                        ...
                                        <div class="ml-4">
                                            <span class="text-dark d-block">Daftar Member</span>
                                            <span class="small">Dapatkan Poin Setiap Transaksi</span>
                                        </div>
                                    </a>
                                    @endif
                                    @endauth
